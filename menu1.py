...
while place_order: 
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            # 2. Ask customer to input menu item number
                menu_selection = input("Enter the item number to order")
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items:
                    ...
                    quantity = input("Enter the quantity of {menu_item} you would like to add")
                    ...
                    else: quantity = 1, ("default to 1 if invalid")
                ...
                selection_invalid = ("Your selection is not valid") 

            else:
                print(selection_invalid)

                # Tell the customer they didn't select a menu option

        else: print("You didn't select a menu option")
            # Tell the customer they didn't select a menu option
    ...
    while True:
        ...
        if keep_ordering in ["Y", "Yes"]:
                # Keep ordering
            print = ("What other item would you like to add")
...
for item in order:
    ...
    items_spaces = str(num_item_spaces)
